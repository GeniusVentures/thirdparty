...
extern IString TOPLEVEL,
               ...
               __identifier(LABEL),
               __identifier(BREAK),
               __identifier(CONTINUE),
               __identifier(SWITCH),
               __identifier(STRING),
               __identifier(TRY),
               __identifier(INF),
               __identifier(NaN),
               __identifier(LLVM_CTTZ_I32),
               __identifier(UDIVMODDI4),
               __identifier(UNARY_PREFIX),
               __identifier(UNARY_POSTFIX),
               __identifier(MATH_FROUND),
               __identifier(MATH_CLZ32),
               __identifier(INT64),
               __identifier(INT64_CONST),
               __identifier(SIMD_FLOAT32X4),
               __identifier(SIMD_FLOAT64X2),
               __identifier(SIMD_INT8X16),
               __identifier(SIMD_INT16X8),
               __identifier(SIMD_INT32X4),
               __identifier(PLUS),
               __identifier(MINUS),
               __identifier(OR),
               __identifier(AND),
               ...
               __identifier(RSHIFT),
               __identifier(LSHIFT),
               __identifier(TRSHIFT),
               __identifier(HEAP8),
               __identifier(HEAP16),
               __identifier(HEAP32),
               __identifier(HEAPF32),
               __identifier(HEAPU8),
               __identifier(HEAPU16),
               __identifier(HEAPU32),
               __identifier(HEAPF64),
               __identifier(F0),
               __identifier(EMPTY),
               __identifier(FUNCTION),
               __identifier(OPEN_PAREN),
               __identifier(OPEN_BRACE),
               __identifier(OPEN_CURLY),
               __identifier(CLOSE_CURLY),
               __identifier(COMMA),
               __identifier(QUESTION),
               __identifier(COLON),
               __identifier(CASE),
